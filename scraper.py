...
#Getting days which scraper should collect 
startingInput = input("Enter starting date (mm/yyyy): ").split('/', 2)
targetYear = int(input("Enter ending year (yyyy): "))

year = int(startingInput[1])
month = int(startingInput[0])
day = 1

#Ensuring number of days in each month is correct
